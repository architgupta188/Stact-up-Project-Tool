...
reportRouter.post('/generate', requireAuth, reportGenerationLimiter, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
reportRouter.get('/:reportId', optionalAuth, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
...
reportRouter.get('/', requireAuth, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const userId = req.user!.id;
...
reportRouter.post('/:reportId/share', requireAuth, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const reportId = getParam(req.params.reportId);
    const userId = req.user!.id;
...
reportRouter.delete('/:reportId', requireAuth, async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    const reportId = getParam(req.params.reportId);
    const userId = req.user!.id;
